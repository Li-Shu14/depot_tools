This repository is copied from `https://chromium.googlesource.com/chromium/tools/depot_tools.git`
Because of the Great Wall we cannot directly download this repo from the original source. 
And I even failed with using VPNs. 
With a friend's help who is now abroad I finally made it. 
Wish this repo will help you.

This repo is believed to be the pre-requisites of `libyuv`.
